...
# Try this as a dynamic way to make externs 
foreach(DLL ${DLL_FILES})
    ...
    file(APPEND ${OUTPUT_HEADER} "extern unsigned char ${DLL_SYMBOL}[];\n")
    file(APPEND ${OUTPUT_HEADER} "extern unsigned int ${DLL_SYMBOL}_len;\n")
endforeach()
